...
/**
 * Created by kamran qadeer on 5/13/2018.
 */

public class Tea_Sub_Det_Adapter extends RecyclerView.Adapter<Tea_Sub_Det_Adapter.MyViewHolder> {
    Context context;
    Cursor cursor;
    public Tea_Sub_Det_Adapter(Context context, Cursor cursor) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new Tea_Sub_Det_Adapter.MyViewHolder(view);
    }
    @Override
